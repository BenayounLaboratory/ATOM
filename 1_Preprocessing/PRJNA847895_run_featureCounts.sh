...
OUTDIR="/scratch1/eschwab/Benayoun_Lee_Lab/ATOM/new_data/PRJNA847895_BMDM_multilane/UCSC_featurecounts_out"
THREADS=8
...
BAM_FILES=(/scratch1/eschwab/Benayoun_Lee_Lab/ATOM/new_data/PRJNA847895_BMDM_multilane/STAR_alignment_UCSC_genome/*/*Aligned.sortedByCoord.out.bam)
