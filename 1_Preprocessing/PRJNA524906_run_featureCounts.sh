...
OUTDIR="/scratch1/eschwab/Benayoun_Lee_Lab/ATOM/new_data/PRJNA524906_microglia/UCSC_featurecounts_out"
THREADS=8
...
BAM_FILES=(/scratch1/eschwab/Benayoun_Lee_Lab/ATOM/new_data/PRJNA524906_microglia/STAR_alignment_UCSC_genome/*/*Aligned.sortedByCoord.out.bam)
